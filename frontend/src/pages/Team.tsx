            ...
            {teamMembers.map((member) => (
              ...
              >
                ...
                <div className="relative overflow-hidden bg-zinc-800 h-64">
                  ...
                  {/* LinkedIn Icon Overlay - Hidden on mobile, visible on hover for desktop */}
                  <a
                    href={member.linkedin}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="absolute top-4 right-4 w-10 h-10 bg-zinc-900/80 backdrop-blur-sm rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 hover:bg-cyan-400 hover:scale-110 hidden sm:flex"
                  >
                ...
                <div className="p-6">
                  ...
                  {/* LinkedIn Button - Visible on mobile, hidden on larger screens */}
                  <a
                    href={member.linkedin}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 px-4 py-2 bg-cyan-400 text-black font-medium rounded-full hover:bg-cyan-300 transition-all duration-300 transform hover:scale-105 sm:hidden"
                  >
