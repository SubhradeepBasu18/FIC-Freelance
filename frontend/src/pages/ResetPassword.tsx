...
import { resetPassword } from '@/configApi/admin';
...
const ResetPassword = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const response = await resetPassword(formData.email, formData.currentPassword, formData.newPassword, formData.confirmNewPassword);
