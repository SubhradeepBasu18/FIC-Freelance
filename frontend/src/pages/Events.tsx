      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-gray-400">Manage live and upcoming events</p>
          </div>
          <button
          ...
          <div className="bg-gray-900 rounded-xl p-6 mb-6 border border-gray-800">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              ...
              <textarea
                ...
                onChange={handleEventInputChange}
                rows={3}
                className="md:col-span-2 px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
              />
        ...
        <div className="mb-8">
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-2xl font-bold text-white">Live Events</h3>
            {liveEvents.length > 2 && (
          ...
          >
            {liveEvents.map(event => (
              <div 
                key={event.id} 
                className="bg-gray-900 rounded-xl p-8 border-2 border-gray-800 hover:border-gray-700 transition-all relative flex-shrink-0 w-96 min-h-[320px] flex flex-col"
              >
                {editingEventId === event.id ? (
                  ...
                  <div className="flex flex-col h-full">
                    ...
                    <div className="flex-1">
                      <h4 className="text-2xl font-bold text-white mb-3 pr-20">{event.title}</h4>
                      <p className="text-gray-400 text-base mb-6 leading-relaxed">{event.description}</p>
                    </div>
                    <div className="mt-auto">
                      <div className="mb-4">
                        <p className="text-white font-semibold text-lg mb-1">{event.location}</p>
                      ...
                      {event.visitLink && (
                        <a
                          ...
                          className="inline-block w-full text-center px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium transition-all border-2 border-blue-500"
                        >
                          Visit
                        </a>
                      )}
        ...
        <div>
          ...
          <div className="space-y-4">
            {upcomingEvents.map(event => (
              <div key={event.id} className="bg-gray-900 rounded-xl p-6 border border-gray-800 hover:border-gray-700 transition-all">
                {editingEventId === event.id ? (
                      ...
                      <div className="flex gap-2">
                        {event.visitLink && (
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium transition-all border-2 border-blue-500"
                          >
                            Visit
                          </a>
                        )}
