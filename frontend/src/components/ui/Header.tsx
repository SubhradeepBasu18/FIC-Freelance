                    ...
                    <div className="hidden md:flex items-center space-x-1 lg:space-x-2">
                        {NAV_ITEMS.map((item) => {
                            ...
                            return (
                                ...
                                >
                                    <button 
                                        className={`relative flex items-center space-x-1 px-4 py-2.5 text-sm font-medium transition-all duration-300 rounded-xl overflow-hidden group ${
                                            isActive
                                                ? "text-cyan-300"
                                        ...
                                        >
                                            {item.links.map((link, index) => (
                                                <Link
                                                    key={link.href}
                                                    to={link.href}
                                                    className={`relative block px-5 py-3 text-sm transition-all duration-200 group overflow-hidden ${
                        ...
                        >
                            <svg
                                className={`w-6 h-6 transition-transform duration-300 ${
                                    activeDropdown === "mobile" ? "rotate-90" : ""
                                }`}
                                fill="none"
                                stroke="currentColor"
                                viewBox="0 0 24 24"
