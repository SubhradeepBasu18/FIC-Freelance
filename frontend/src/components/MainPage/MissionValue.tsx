        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="relative group">
              <div className="absolute -inset-1 bg-gradient-to-br from-cyan-400 to-blue-600 rounded-3xl blur-xl opacity-20 group-hover:opacity-40 transition duration-500"></div>
              <div className="relative bg-zinc-900/90 backdrop-blur-xl rounded-2xl border border-cyan-400/30 overflow-hidden h-full">
                ...
                <div className="p-10">
                  ...
                  <div className="bg-gradient-to-br from-cyan-400/10 to-blue-500/10 p-6 rounded-xl border border-cyan-400/20">
                    <p className="text-cyan-400 text-xl font-semibold italic text-center">
            ...
            {/* Vision Card */}
            <div className="relative group">
              <div className="absolute -inset-1 bg-gradient-to-br from-purple-600 to-pink-600 rounded-3xl blur-xl opacity-20 group-hover:opacity-40 transition duration-500"></div>
              <div className="relative bg-zinc-900/90 backdrop-blur-xl rounded-2xl border border-purple-400/30 overflow-hidden h-full">
                <div className="absolute top-0 left-0 right-0 h-2 bg-gradient-to-r from-purple-600 to-pink-500"></div>
                ...
                <div className="p-10">
                  ...
                  <div className="bg-gradient-to-br from-purple-400/10 to-pink-500/10 p-6 rounded-xl border border-purple-400/20">
                    <p className="text-purple-400 text-xl font-semibold italic text-center">
